...
const API_URL = 'https://marea-picante-prod-server.onrender.com/api/products';
const CATEGORIES_URL = 'https://marea-picante-prod-server.onrender.com/api/categories';
